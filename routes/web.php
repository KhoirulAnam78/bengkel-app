...
Route::group(['middleware' => ['web', 'auth', 'verified']], function () {
    ...
    // Laporan
    Route::get('laporan-pemasukan', [LaporanController::class, 'laporanPemasukan'])->name('laporan_pemasukan');
    Route::get('laporan-pengeluaran', [LaporanController::class, 'laporanPengeluaran'])->name('laporan_pengeluaran');
