            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="about_part_img">
                        <img src="{{ asset('assets/homepage/img/about_part_img.png') }}" alt="">
                    </div>
                </div>
    ...
    <section class="about_part experiance_part section_padding">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="about_part_img">
                        <img src="{{ asset('assets/homepage/img/experiance_img.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="filters-content">
                <div class="row justify-content-between portfolio-grid">
                    <div class="col-lg-4 col-sm-6 all buildings">
                        <div class="single_our_project">
                            <div class="single_offer">
                                <img src="{{ asset('assets/homepage/img/project_1.png') }}" alt="offer_img_1">
                    ...
                    <div class="col-lg-4 col-sm-6 all rebuild">
                        <div class="single_our_project">
                            <div class="single_offer">
                                <img src="{{ asset('assets/homepage/img/project_2.png') }}" alt="offer_img_1">
                                <div class="hover_text">
                                    <p>Bank Protected</p>
                                    <a href="#"><h2>Banking & Finance</h2></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-sm-6 all architecture">
                        <div class="single_our_project">
                            <div class="single_offer">
                                <img src="{{ asset('assets/homepage/img/project_3.png') }}" alt="offer_img_1">
                                <div class="hover_text">
                                    <p>Bank Protected</p>
                                    <a href="#"><h2>Banking & Finance</h2></a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                        <img src="{{ asset('assets/homepage/img/icon/Icon_1.svg') }}" alt="">
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                        <img src="{{ asset('assets/homepage/img/icon/Icon_2.svg') }}" alt="">
                    </div>
                    <div class="single_member_counter">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                        <img src="{{ asset('assets/homepage/img/icon/Icon_3.svg') }}" alt="">
                    </div>
                    <div class="single_member_counter">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                        <img src="{{ asset('assets/homepage/img/icon/Icon_4.svg') }}" alt="">
                    </div>
                    <div class="single_member_counter">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="review_part_cotent owl-carousel">
                        <div class="single_review_part">
                            <img src="{{ asset('assets/homepage/img/client/client_2.png') }}" alt="">
                        ...
                        <div class="single_review_part">
                            <img src="{{ asset('assets/homepage/img/client/client_1.png') }}" alt="">
                            <div class="tour_pack_content">
                                <p> Life open fifth midst lesser place light after unto move that make had void and whales. So after void called  whose were cattle fourth seed Image yielding is given every own tree Image</p>
                                <h4>Sawpalo, Brasil</h4>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{ asset('assets/homepage/img/blog/blog_1.png') }}" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{ asset('assets/homepage/img/blog/blog_2.png') }}" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-comments"></span>2 Comments</li>
                                    <li> <span class="ti-heart"></span>2k Like</li>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{ asset('assets/homepage/img/blog/blog_3.png') }}" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-comments"></span>2 Comments</li>
                                    <li> <span class="ti-heart"></span>2k Like</li>
