        ...
        <div class="modal-content">
            <form>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-add">Tambah Data Mekanik </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan nama Mekanik"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" class="form-control" placeholder="Alamat Mekanik" wire:model.live="alamat" rows="5"></textarea>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-edit">Edit Mekanik </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        wire:click="empty()"> </button>
                </div>
...
<div id="modal-form-delete" class="modal fade" tabindex="-1" wire:ignore.self aria-labelledby="modal-form-delete"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-form-delete">Hapus Mekanik</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                    wire:click="empty()"> </button>
            </div>
            <div class="modal-body">
